...
export const getCapabilites = async (
    schemaId: string,
    capabilityId: string,
) => {
    "use cache";
    ...
    return analysis?.capabilities.find((c) => c.id === capabilityId) ?? null;
};
...
const page = async (
    props: PageProps<"/workflows/new/[schemaId]/[capabilityId]">,
) => {
    ...
    console.log(capability, workflow, workflowRecord);
    return (
        <NewWorkflowPage
