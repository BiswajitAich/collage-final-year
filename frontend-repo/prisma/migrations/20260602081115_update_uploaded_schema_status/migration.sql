/*
  ...
  - The values [UPLOADING] on the enum `SchemaStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SchemaStatus_new" AS ENUM ('UPLOADED', 'ANALYZING', 'ANALYZED', 'FAILED');
